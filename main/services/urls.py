...
from .views import (
    AdminDashboardView,
    AdminEntidadViewSet,
    EntidadPublicaDetalleView,
    EntidadViewSet,
    ResenaEntidadViewSet,
    ResenaServicioViewSet,
    ServicioCategoriaViewSet,
...
router.register("categorias", ServicioCategoriaViewSet, basename="categorias")
router.register("admin/entidades", AdminEntidadViewSet, basename="admin-entidades")
